...
El biplot nos sirve para resumir las relaciones entre variables, entre objetos y entre variables y objetos.
...
Contrario a lo que conjeturamos las variables tiene un aporte similar en cuanto a la variabilidad del dataset.
...
Elegimos el número de factores y obtenemos la estimación de la matriz de cargas.
...
Representación gráfica de las cargas en el espacio de los factores rotados.
