...
4\. trestbps: presión arterial en reposo (en mm Hg al ingreso en el hospital) 5. chol: colesterol sérico en mg/dl 6. fbs: (azúcar en sangre en ayunas \\\> 120 mg/dl) (1 = verdadero; 0 = falso).
...
```{r warning=FALSE}
ggplot(data2, aes(x = diagnosis, fill=diagnosis)) +
geom_histogram(binwidth = .5)
```

Se debe considerar que la variable target, tiene un sesgo hacia uno de los valores.
